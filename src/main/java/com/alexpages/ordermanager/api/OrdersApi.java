...
public interface OrdersApi {
    ...
    @Operation(operationId = "postOrder", summary = "Allows you to post an order", description = "Service that allows you to register an order. The order will have related information about customers, employees and items",    tags = { "orders" },  responses = {  @ApiResponse(responseCode = "200", description = "Created", content = {  @Content(mediaType = "application/json", schema = @Schema(implementation = OrderPostResponse.class))  }),  @ApiResponse(responseCode = "400", description = "Bad request. The request body does not follow the expected format.", content = {  @Content(mediaType = "application/json", schema = @Schema(implementation = PostOrder400Response.class))  }),  @ApiResponse(responseCode = "403", description = "Unauthorized request. The user is not authorized or JWT was expired.", content = {  @Content(mediaType = "application/json", schema = @Schema(implementation = PostOrder403Response.class))  }),  @ApiResponse(responseCode = "500", description = "Internal Server Error.", content = {  @Content(mediaType = "application/json", schema = @Schema(implementation = PostOrder500Response.class))  })  })
