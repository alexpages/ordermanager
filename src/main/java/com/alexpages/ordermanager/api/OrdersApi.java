...
import com.alexpages.ordermanager.api.domain.TakeOrderById409Response;
...
public interface OrdersApi {
    ...
    @Operation(operationId = "takeOrderById", summary = "Allows you to change status of an order", description = "Service that allows you to change the status of an order.",    tags = { "orders" },  responses = {  @ApiResponse(responseCode = "200", description = "OK", content = {  @Content(mediaType = "application/json", schema = @Schema(implementation = OrderPatchResponse.class))  }),  @ApiResponse(responseCode = "400", description = "Bad request. The request body does not follow the expected format.", content = {  @Content(mediaType = "application/json", schema = @Schema(implementation = PostOrder400Response.class))  }),  @ApiResponse(responseCode = "403", description = "Unauthorized request. The user is not authorized or JWT was expired.", content = {  @Content(mediaType = "application/json", schema = @Schema(implementation = PostOrder403Response.class))  }),  @ApiResponse(responseCode = "404", description = "Resource not found.", content = {  @Content(mediaType = "application/json", schema = @Schema(implementation = GetOrderById404Response.class))  }),  @ApiResponse(responseCode = "409", description = "Conflict.", content = {  @Content(mediaType = "application/json", schema = @Schema(implementation = TakeOrderById409Response.class))  })  })
    @RequestMapping( method = RequestMethod.PATCH, value = "/orders/{orderId}", produces = { "application/json" }, consumes = { "application/json" })      
    ResponseEntity<OrderPatchResponse> takeOrderById( @Parameter(name = "orderId", description = "Identifier of an order", required = true, in = ParameterIn.PATH) @PathVariable("orderId") Long orderId,@Parameter(name = "OrderPatchInput", description = "", required = true) @Valid @RequestBody OrderPatchInput orderPatchInput);
}
