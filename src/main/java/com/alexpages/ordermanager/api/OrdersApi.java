...
public interface OrdersApi {
    ...
    @Operation(operationId = "getOrderById", summary = "Allows you to get the details of an order", description = "Service that allows you to recover all the information related to a order (employee, customer, items, etc.)",    tags = { "orders" },  responses = {  @ApiResponse(responseCode = "200", description = "OK", content = {  @Content(mediaType = "application/json", schema = @Schema(implementation = OrderDetails.class))  }),  @ApiResponse(responseCode = "404", description = "Resource not found.", content = {  @Content(mediaType = "application/json", schema = @Schema(implementation = GetOrderById404Response.class))  }),  @ApiResponse(responseCode = "500", description = "Internal Server Error.", content = {  @Content(mediaType = "application/json", schema = @Schema(implementation = PostOrder500Response.class))  })  })
    ...
    @Operation(operationId = "takeOrderById", summary = "Allows you to change status of an order", description = "Service that allows you to change the status of an order.",    tags = { "orders" },  responses = {  @ApiResponse(responseCode = "200", description = "OK", content = {  @Content(mediaType = "application/json", schema = @Schema(implementation = OrderPatchResponse.class))  }),  @ApiResponse(responseCode = "403", description = "Unauthorized request. The user is not authorized or JWT was expired.", content = {  @Content(mediaType = "application/json", schema = @Schema(implementation = PostOrder403Response.class))  }),  @ApiResponse(responseCode = "404", description = "Resource not found.", content = {  @Content(mediaType = "application/json", schema = @Schema(implementation = GetOrderById404Response.class))  }),  @ApiResponse(responseCode = "500", description = "Internal Server Error.", content = {  @Content(mediaType = "application/json", schema = @Schema(implementation = PostOrder500Response.class))  })  })
